    ...
    return (
        <>
            ...
            <div className="w-full flex absolute justify-center items-center mt-[500px]">
                <div className="flex items-center bg-white rounded-full shadow-md overflow-hidden border-2 border-gray-300 focus-within:border-secondary transition">
                    <input 
                        type="text"  
                        placeholder="Search products..." 
                        className="px-4 py-2 outline-none w-[250px] md:w-[400px] text-gray-800"
                        value={query}
